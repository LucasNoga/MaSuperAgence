...
class __TwigTemplate_0a8cd0bc25bf8f8f844392a282228177b6d10172e198640977de523757646aa1 extends Twig_Template
{
    ...
    ";
        // line 114
        if (("explain" == (isset($context["pages"]) || array_key_exists("pages", $context) ? $context["pages"] : (function () { throw new Twig_Error_Runtime('Variable "pages" does not exist.', 114, $this->source); })()))) {
            // line 115
            echo "        ";
        ...
        ";
                ...
                foreach ($context['_seq'] as $context["i"] => $context["query"]) {
                    ...
                    if (twig_get_attribute($this->env, $this->source, $context["query"], "explainable", array())) {
                        ...
                        // line 255
                        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("_profiler", array("panel" => "db", "token" => (isset($context["token"]) || array_key_exists("token", $context) ? $context["token"] : (function () { throw new Twig_Error_Runtime('Variable "token" does not exist.', 255, $this->source); })()), "pages" => "explain", "connection" => $context["connection"], "query" => $context["i"])), "html", null, true);
                            ...
                            <td>
                                ...
                                <div class=\"text-small font-normal\">
                                    ...
                                    {% if query.explainable %}
                                        &nbsp;&nbsp;
                                        <a class=\"link-inverse\" href=\"{{ path('_profiler', { panel: 'db', token: token, pages: 'explain', connection: connection, query: i }) }}\" onclick=\"return explain(this);\" data-target-id=\"explain-{{ i }}-{{ loop.parent.loop.index }}\">Explain query</a>
                                    {% endif %}
                                </div>
...
{% endmacro %}
", "@Doctrine/Collector/db.html.twig", "D:\\Dev\\MaSuperAgence\\vendor\\doctrine\\doctrine-bundle\\Resources\\views\\Collector\\db.html.twig");
    }
}
